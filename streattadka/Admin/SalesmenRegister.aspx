<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminmaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="~/Admin/SalesmenRegister.aspx.cs" Inherits="SalesmenRegister" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="page-header">
    ...
    <asp:label class="col-sm-3 control-label no-padding-right" runat="server" text="Area"></asp:label>
            ...
            <%--<asp:textbox id="txtAId" class="col-xs-10 col-sm-5" runat="server"></asp:textbox>--%>
    <br /> <br />
