<%@ Page Title="" Language="C#" MasterPageFile="~/Stall Owner/StallOwnerMasterPage.master" AutoEventWireup="true" CodeFile="ChangeUnsuccess.aspx.cs" Inherits="Stall_Owner_ChangeUnsuccess" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="portlet-body">
        <div class="form-horizontal">
            Dear user you have either entered the wrong old password or you have not entered the same new password.
            <br /><br />
