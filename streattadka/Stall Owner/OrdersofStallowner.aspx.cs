...
public partial class Stall_Owner_OrdersofStallowner : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  var dataOid = dc.ordersses.OrderByDescending(x => x.or_id).FirstOrDefault();
        ...
        var data = (from t in dc.orderdetails where t.Stallid == stid select t).ToList();
        ...
        foreach (var x in data)
        {
            ...
            str += "<tr><td>"+name+"</td><td>" + x.pname + "</td><td>" + x.prize + "</td><td>" + x.stallname + "</td><td>" + x.quantity + "</td><td>" + x.prize * x.quantity + "</td><td><img src='~/Salesman/Street Tadka_images/" + x.pimg + "' width=25% /></td></tr>";
