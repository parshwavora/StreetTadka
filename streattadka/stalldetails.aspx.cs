...
public partial class stalldetails : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        foreach (var x in data)
        {
            ...
            y++;
            str += "<td><img src='Admin/Street Tadka_images/" + x.st_pic + "' width='100px' height='100px' /> <br> <a href='Stall.aspx?Id=" + x.st_id  + "'>" + x.st_name  + "</a></td>";
        ...
        foreach (var x in data2)
        {
            ...
            z++;
            str2 += "<td><img src='Admin/Street Tadka_images/" + x.pimage + "' width='100px' height='100px' /> <br> <a href='productdetails.aspx?PId=" + x.sp_id  + "'>" + x.price  + "Rs. == " + x.pname   + "</a></td>";
